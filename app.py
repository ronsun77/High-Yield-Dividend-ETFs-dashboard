...
if selected_names:
    if sum(weights) != 1.0:
        ...
        if not df_price.empty:
            ...
            if leverage_pct > 0:
                curr_l_m, curr_l_t = run_simulation(df_price[selected_tickers], div_raw_dict, weights, initial_capital, leverage_pct, borrow_rate, annual_expense, enable_rebalance)
